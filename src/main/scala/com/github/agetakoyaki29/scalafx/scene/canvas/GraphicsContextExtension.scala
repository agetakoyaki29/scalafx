...
object XXX {
  ...
  implicit class GraphicsContextExtension(that : GraphicsContext) {
    ...
    def strokeLine2(pt1: Point2D, pt2: Point2D) = that.strokeLine(pt1.getX, pt1.getY, pt2.getX, pt2.getY)
    
    def strokeCircle2(pt1: Point2D, pt2: Point2D) = this.strokeCircle(pt1.getX, pt1.getY, pt2.getX, pt2.getY)
    def fillCircle2(pt1: Point2D, pt2: Point2D) = this.fillCircle(pt1.getX, pt1.getY, pt2.getX, pt2.getY)
  }
